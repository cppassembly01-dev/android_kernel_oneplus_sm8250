...
static struct devfreq_msm_adreno_tz_data adreno_tz_data = {
	...
	.orion_aggressiveness = 225,
	.orion_boost_level = 0,
	.orion_boost_ms = 240,
	.orion_boost_enable = true,
	.orion_scene_boost_ms = 360,
	.orion_downscale_delay_ms = 120,
	.orion_transition_boost_pct = 42,
	.orion_transition_contexts = 2,
	.orion_upthreshold_pct = 72,
	.orion_downthreshold_pct = 8,
	.orion_load_filter_pct = 78,
...
int adreno_wake_nice = -10;

/* Number of milliseconds to stay active active after a wake on touch */
unsigned int adreno_wake_timeout = 150;
		...
		struct platform_device *pdev)
{
	...
	/*
	 * Avoid aggressive micro-idle transitions that cause nap/wake thrash
	 * and frametime jitter in bursty graphics workloads.
	 */
	if (timeout < 120)
		timeout = 120;
