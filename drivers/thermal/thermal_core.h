...
#ifdef CONFIG_THERMAL_GOV_SMOOTH_STEP
int thermal_gov_smooth_step_register(void);
void thermal_gov_smooth_step_unregister(void);
#else
static inline int thermal_gov_smooth_step_register(void) { return 0; }
static inline void thermal_gov_smooth_step_unregister(void) {}
#endif /* CONFIG_THERMAL_GOV_SMOOTH_STEP */
